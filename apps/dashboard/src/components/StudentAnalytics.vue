  ...
  <div class="w-full">
    ...
    <div v-if="uiVariant === 'redesigned'" class="w-full">
      ...
      <div v-else-if="viewMode === 'list' && selectedCategory">
        <div v-if="loadingStudents" class="text-center py-16 bg-white rounded-2xl border border-slate-200/60 shadow-academic text-slate-400">
          <Activity class="w-8 h-8 animate-spin mx-auto mb-3 text-blue-600" />
          <p class="font-medium text-sm">正在讀取班級花名冊與成績統計...</p>
        </div>

        <div v-else class="bg-white rounded-2xl shadow-academic border border-slate-200/60 overflow-hidden">
          ...
          <div class="p-4 sm:p-0">
            ...
            <div class="lg:hidden space-y-3.5">
              ...
              >
                <div class="flex justify-between items-center">
                  <div class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-full bg-blue-50 text-blue-600 border border-blue-150 flex items-center justify-center font-bold text-sm">
                  ...
                  <div>
                    ...
                    <span 
                      ...
                      :class="[
                        ...
                        student.totalAttempts === 0 ? 'bg-slate-50 text-slate-400' : 'bg-rose-50 text-rose-700 border border-rose-150'
                      ]"
                    >
              ...
              <div v-if="sortedAndFilteredStudents.length === 0" class="text-center py-8 text-slate-400 text-sm">
                尚無學生資料或查無符合條件之學生。
              </div>
            </div>
            ...
            <table class="w-full text-left border-collapse lg:table hidden">
              <thead>
                <tr class="bg-slate-50 text-slate-500 text-xs border-b border-slate-200">
                  ...
                  <th class="p-4 font-bold tracking-wide uppercase w-40 border-l border-slate-100 text-center">該班準率</th>
              ...
              <tbody class="divide-y divide-slate-100">
                ...
                >
                  <td class="p-4">
                    <div class="flex items-center gap-3">
                      <div class="w-9 h-9 rounded-full bg-blue-50 text-blue-600 border border-blue-100 flex items-center justify-center font-bold text-xs">
                        {{ student.display_name?.charAt(0) || 'U' }}
                      </div>
                      <div>
